...
class Blockchain(object):
    ...
    def proof_of_work(self, last_proof):
        """A Proof of Work algorithm (PoW) 
        is how new Blocks are created or mined on the blockchain. 
...
def mine():
    # We run proof of work algo to get next proof...
...
def new_transaction():
    ...
    # Check required fields are in posted data
